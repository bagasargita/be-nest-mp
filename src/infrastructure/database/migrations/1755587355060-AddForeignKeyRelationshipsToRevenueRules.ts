...
export class AddForeignKeyRelationshipsToRevenueRules1755587355060 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop indexes
    await queryRunner.query(`DROP INDEX "IDX_account_add_ons_billing_method_id"`);
    await queryRunner.query(`DROP INDEX "IDX_account_package_tier_billing_method_id"`);
